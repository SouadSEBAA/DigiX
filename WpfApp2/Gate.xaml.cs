...
namespace WpfApp2
{
    ...
    public partial class Gate : UserControl
    {
        ...
        private void AjouterEntrée(object sender, MouseButtonEventArgs e)
        {
            Type type = outil.GetType();
            ...
            if ( (type.Name == "ET") || (type.Name == "OU")  || (type.Name == "NAND") || (type.Name == "OUX") || (type.Name == "NOR"))
            {
                ClasseEntree classeEntree = new ClasseEntree(1, Disposition.left, true, false);
                outil.AjoutEntree(classeEntree);
                AjouterIO(LeftGate, true, outil.getnbrentrees() - 1);
                MAJ_Path(outil.getnbrentrees(), outil.getnbrsoryies());
            }
        }


        private void SupprimerEntrée(object sender, MouseButtonEventArgs e)
        {
            Type type = outil.GetType();
